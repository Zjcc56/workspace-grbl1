...
cprequire_test(["inline:com-chilipeppr-workspace-shapeoko3"], function(ws) {
    ...
    $('title').html("shapeoko3 Workspace");
...
cpdefine("inline:com-chilipeppr-workspace-shapeoko3", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-shapeoko3", // Make the id the same as the cpdefine id
        name: "Workspace / shapeoko3", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace shapeoko3.`,
