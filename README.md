# com-chilipeppr-workspace-shapeoko3
A ChiliPeppr Workspace shapeoko3.



## ChiliPeppr Workspace / shapeoko3
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-shapeoko3 |
| Name                  | Workspace / shapeoko3 |
| Description           | A ChiliPeppr Workspace shapeoko3. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/Zjcc56/workspace-shapeoko3/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/coryallenscott/shaeoko3 |
| Github URL            | http://github.com/Zjcc56/workspace-shapeoko3 |
| Test URL              | https://preview.c9users.io/coryallenscott/shaeoko3/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/Zjcc56/workspace-shapeoko3/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-shapeoko3"], // the id you gave your workspace
      function(myWorkspaceShapeoko3) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / shapeoko3 just got loaded.", myWorkspaceShapeoko3);
        myWorkspaceShapeoko3.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-shapeoko3"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / shapeoko3"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace shapeoko3."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/Zjcc56/workspace-shapeoko3/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/coryallenscott/shaeoko3"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/Zjcc56/workspace-shapeoko3"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://shaeoko3-coryallenscott.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
